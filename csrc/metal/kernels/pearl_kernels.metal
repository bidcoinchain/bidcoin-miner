// bidcoin PoW Metal kernels.
//
// Consensus reference: zk-pow/src in bidcoin-research-labs/bidcoin (ISC), pinned
// in PINNED_bidcoin_COMMIT.txt; NumPy restatement in bidcoin_metal_miner/reference.py.
...
// ── Noise generation (bidcoin_noise.rs) ───────────────────────────────────────
