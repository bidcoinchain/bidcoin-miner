// Objective-C++ host for the bidcoin Metal backend.
//
...
int pm_compile(pm_ctx *ctx, const pm_shape *shape, char *err, size_t errlen) {
  @autoreleasepool {
    ...
    NSString *src = [[NSString alloc] initWithBytes:bidcoin_KERNELS_MSL
                                             length:bidcoin_KERNELS_MSL_LEN
