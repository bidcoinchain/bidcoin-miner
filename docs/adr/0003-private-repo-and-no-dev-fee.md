...
> `Muskwak/Open-bidcoin-Miner`. It did not: `bidcoin-research-labs/bidcoin` is ISC and
...
Upstream `Muskwak/Open-bidcoin-Miner` ships under a custom licence (not MIT,
...
**`bidcoin/perle-minig` must stay private.** It is private today, which is
