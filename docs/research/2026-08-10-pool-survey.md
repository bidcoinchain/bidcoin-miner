...
## LuckyPool — `bidcoin-eu1.luckypool.io:3360` ✅ 08-10 (reverse-engineered)
...
- The undocumented `bidcoin-cpu-eu1.luckypool.io:3370` **accepts TCP** — the
  endpoint exists; dialect unprobed.

## K1Pool — `eu.bidcoin.k1pool.com:5566` ⚠️ 08-09
...
## LuckyPool CPU port — `bidcoin-cpu-eu1.luckypool.io:3370` ✅ 08-10
