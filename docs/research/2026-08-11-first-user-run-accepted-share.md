...
| step | evidence |
| ---- | -------- |
| setup + build (idempotent rerun) | `setup complete`, `built build/libbidcoinmetal.dylib` |
...
| pool | LuckyPool `bidcoin-eu1.luckypool.io:3360`, varDiff 888,888 |
...
`bidcoin.luckypool.io`, seconds after the accept (abridged):
