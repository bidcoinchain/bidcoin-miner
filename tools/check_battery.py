    ...
    with tempfile.TemporaryDirectory() as d:
        ...
        try:
            ...
            if proc.poll() is None:
                proc.kill()
        t = toasts(shims)
        want_pause = 'display notification "Paused — on battery" with title "bidcoin miner"'
        want_resume = 'display notification "Resuming — on AC power" with title "bidcoin miner"'
