...
or privilege-escalation imports anywhere in bidcoin_metal_miner/.
...
from bidcoin_metal_miner import economics  # noqa: E402
...
def check_session_earned() -> bool:
    ...
    with tempfile.TemporaryDirectory() as d:
        ...
        r = subprocess.run(
            [sys.executable, "-m", "bidcoin_metal_miner.miner",
...
def check_offline_no_sudo() -> bool:
    ...
    bad = []
    pkg = os.path.join(ROOT, "bidcoin_metal_miner")
