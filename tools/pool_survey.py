...
WORKER = "survey"
AGENT = "bidcoin-miner/0.0-survey"

POOLS = [
    # (label, host, port, handshake lines)
    ("luckypool:3360", "bidcoin-eu1.luckypool.io", 3360, [
    ...
    ("k1pool:5566", "eu.bidcoin.k1pool.com", 5566, [
        {"id": 1, "method": "mining.subscribe", "params": [AGENT]},
...
PROBES = [
    ("luckypool cpu-eu1:3370 (undocumented)", "bidcoin-cpu-eu1.luckypool.io", 3370),
]
